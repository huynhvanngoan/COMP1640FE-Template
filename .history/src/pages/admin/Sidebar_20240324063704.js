...
import { MdOutlineSupervisorAccount } from "react-icons/md";import { TbArrowNarrowLeft } from "react-icons/tb";
    ...
    <div className='left-0 top-0 w-64 h-screen bg-[#0f1941] p-4'>
        <div className='flex flex-col'>
           <div className='relative flex h-10 justify-end'>
            <TbLayoutSidebarLeftCollapse  className='text-3xl text-gray-300  hover:text-white cursor-pointer'/>
           </div>
