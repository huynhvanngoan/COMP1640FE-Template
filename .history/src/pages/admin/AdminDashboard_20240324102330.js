    ...
    <>
                      ...
                      <tr class="border-b border-dashed last:border-b-0">
                        <td class="p-3 pl-0">
                          <div class="flex items-center">
                            ...
                            <div class="flex flex-col justify-start">
                              <Link href="#" class="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> Resto Aperto </Link>
                            </div>
                          </div>
                        </td>
                        <td class="p-3 pr-0 text-end">
      ...
      <div class="flex flex-wrap -mx-3 mb-5">
        <div class="w-full max-w-full sm:w-3/4 mx-auto text-center">
          <p class="text-sm text-slate-500 py-1"> Tailwind CSS Component from <Link href="https://www.loopple.com/theme/riva-dashboard-tailwind?ref=tailwindcomponents" class="text-slate-700 hover:text-slate-900" target="_blank">Riva Dashboard</Link> by <Link href="https://www.loopple.com" class="text-slate-700 hover:text-slate-900" target="_blank">Loopple Builder</Link>. </p>
        </div>
      </div>
    </>
  )
