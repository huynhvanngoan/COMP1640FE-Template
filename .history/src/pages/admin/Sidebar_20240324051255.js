        ...
        <div className='flex items-center'>
          <ul className='my-4  border-t pt-4 w-full'>
            <li className='mb-4' active>
              <Link to="#" className='flex w-full rounded-md items-center space-x-2 text-gray-200 px-4 py-2 text-xl hover:bg-[#080e24] hover:text-white group-[.active]:bg-gray-700 group-[.active]:text'>
                <FaChartPie />
                <span>Statistic</span>
              </Link>
            </li>
