    ...
    <div className={`left-0 top-0 h-screen bg-[#0f1941] p-4 ${colapse ? "w-64" : "w-20"} duration-300`}>
        <div className='flex flex-col'>
           <div className='relative flex h-10 justify-end'>
            <TbArrowNarrowLeft  className={`text-3xl bg-slate-200 rounded-full cursor-pointer absolute -right-7 border border-[#080e24] hover:text-white ${colapse ? 'r'}`} onClick={() => setColapse(!colapse)} />
           </div>
